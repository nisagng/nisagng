...
| :--- | :--- | :--- |
| **Autonomous Content Generation** | Engineered an autonomous AI agent utilizing Amazon Bedrock to produce structured, fully formatted HTML blog posts. | Python, Amazon Bedrock, LLMs |
| **Intelligent Grant Automation** | Developed an automated agent integrating APIs to extract real-time grant opportunities and draft application responses. | Python, Tavily API, Nova Pro |
| **Dynamic Corporate Web Architecture** | Designed and developed a comprehensive blog interface with a dynamic headline slider and custom admin panel. | HTML/CSS/JS, MySQL |
| **Advanced Statistical Simulations** | Developed complex scripts to simulate probability distribution functions, limits, and differential equations. | R |
...
- 💼 **LinkedIn:** [linkedin.com/in/nisanurgungor](https://www.linkedin.com/in/nisanurgungor)
- 📧 **Email:** [nisanurgungor54@gmail.com](mailto:nisanurgungor54@gmail.com)
